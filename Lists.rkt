...
;; 2 PTS
(define (yoda words)
 append(append(list(car(reverse words)))(reverse(cdr(reverse words)))))
...
(append(append(cdr word)(list(car word))) '(a y)))
...
append(list(/(-(- 0 b)(sqrt(-(* b b)(* 4 a c))))(* 2 a)) (/(+(- 0 b)(sqrt(-(* b b)(* 4 a c))))(* 2 a))))
...
(define (combine-courses s1 s2)
  append(append (car(reverse s1)) (car(reverse s2))))
